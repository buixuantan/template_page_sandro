define(['jquery','ias','ajaxinfinitescroll','mage/storage','jquery/jquery-storageapi'],function($){"use strict";window.ajaxInfiniteScroll={initInfiniteScroll:function(){jQuery(function($){var config={container:'.products.wrapper .product-items',item:'.product-item',pagination:'.toolbar .pages, .toolbar .limiter',next:'.pages .action.next',negativeMargin:window.negativeMargin};var pagertext=jQuery(".toolbar-amount");var toolbarCount=jQuery(".toolbar-amount .toolbar-number").length;if(toolbarCount>2){jQuery(".toolbar-amount .toolbar-number:nth-child(1)").text('1');jQuery(".toolbar-amount .toolbar-number:nth-child(2)").hide();pagertext.html(pagertext.html().replace(/\-/g,''));pagertext.html(pagertext.html().replace(/\of/g,'to'));}
